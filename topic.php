...
else
{
	...
	else
	{
		while($row = mysql_fetch_assoc($result))
		{
			...
			{
				echo '<tr><td colspan=2>Você precisa ter acesso ao sitema para responder, <a href="signin.php">Clique aqui</a> para entrar. 
				Se ainda não tem uma conta, <a href="signup.php">Clique aqui</a> para cria-la.';
			}
			else
			{
				//show reply box
